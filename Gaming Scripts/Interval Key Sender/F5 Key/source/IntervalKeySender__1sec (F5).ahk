...
Menu, Tray, Tip, Interval Key Sender`n1 Second Version`n`nHit (Home) key to send the (F5) key every second`nHit (Home) key again to turn it off

{
	global SPAM_KEY := "F5" ;; Set the key combo for quick saving
