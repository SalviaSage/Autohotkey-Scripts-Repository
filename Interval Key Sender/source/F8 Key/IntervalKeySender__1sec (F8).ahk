...
Menu, Tray, Tip, Interval Key Sender`n1 Second Version`n`nHit (Home) key to send the (F8) key every second`nHit (Home) key again to turn it off

{
	global SPAM_KEY := "F8" ;; Set the key combo for quick saving
