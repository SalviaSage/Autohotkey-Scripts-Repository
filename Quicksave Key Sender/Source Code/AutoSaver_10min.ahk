...
;; Basically, it sends a specific key repeatedly with timed intervals, such as 5 minutes. This time interval can be changed on line 15 here.
;; The script is turned off by default and has to be turned on by pressing ctrl + alt + o.

;; User Data

Menu, Tray, Tip, AutoSaver 10min`n`nHit CTRL+ALT+O to send the F5 key every 10 minutes.
