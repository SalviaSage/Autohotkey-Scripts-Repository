;; FastApostrophe (Right to Left) (Hairspaced) (No-Break), Hold Version, 500ms
...
Menu, Tray, Tip, % "Fast Apostrophe`n( Right to Left )`n( Hairspaced )`n( No-Break )`n500 ms version"
