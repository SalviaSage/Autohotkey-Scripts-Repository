;; FastApostrophe (Right to Left) (Hairspaced) (No-Break), Hold Version, 250ms
...
Menu, Tray, Tip, % "Fast Apostrophe`n( Right to Left )`n( Hairspaced )`n( No-Break )`n250 ms version"
