;; FastApostrophe (Hairspaced) (No-Break), Hold Version, 250ms
...
Menu, Tray, Tip, % "Fast Apostrophe`n( Hairspaced )`n( No-Break )`n250 ms version"

#include Lib\TapHoldManager.ahk

#SingleInstance force
transpositions := { "'": ["ʼ", "ʻ", "′", "″", "‴", "⁗"] ;; 0
                 , """": ["“  ”{Left}{Left}{U+FEFF}{U+FEFF}{Left}", "‘  ’{Left}{Left}{U+FEFF}{U+FEFF}{Left}", "„  “{Left}{Left}{U+FEFF}{U+FEFF}{Left}"] ;; 1
                  , ".": ["{U+0021}", "…", "·"] ;; 2
                  , "\": ["•", "⁃", "▪"] ;; 3
                  , ",": [" ", "‍"] ;; 4
                  , "-": ["–", "—", "⸺", "⸻"] ;; 5
...
;; NEED TO USE QUESTION MARKS AND EXCLAMATION MARKS WITH UNICODE CODES AND TEST AGAIN.
                  ...
                  , "(": ["(  ){Left}{Left}{U+FEFF}{U+FEFF}{Left}"] ;; 1
                  , "[": ["[  ]{Left}{Left}{U+FEFF}{U+FEFF}{Left}", "⌈  ⌉{Left}{Left}{U+FEFF}{U+FEFF}{Left}", "⌊  ⌋{Left}{Left}{U+FEFF}{U+FEFF}{Left}", "⸢  ⸣{Left}{Left}{U+FEFF}{U+FEFF}{Left}", "⸤  ⸥{Left}{Left}{U+FEFF}{U+FEFF}{Left}"] ;; 2
