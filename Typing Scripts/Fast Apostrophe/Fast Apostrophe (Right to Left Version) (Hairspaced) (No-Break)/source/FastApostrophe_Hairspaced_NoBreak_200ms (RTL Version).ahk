;; FastApostrophe (Right to Left) (Hairspaced) (No-Break), Hold Version, 200ms
...
Menu, Tray, Tip, % "Fast Apostrophe`n( Right to Left )`n( Hairspaced )`n( No-Break )`n200 ms version"
