;; FastApostrophe (Right to Left) (Hairspaced) (No-Break), Hold Version, 333ms
...
Menu, Tray, Tip, % "Fast Apostrophe`n( Right to Left )`n( Hairspaced )`n( No-Break )`n333 ms version"
...
;; 14 Reversed Question Mark, Fraction Slash
...
;; NEED TO USE QUESTION MARKS AND EXCLAMATION MARKS WITH UNICODE CODES AND TEST AGAIN.
                  ...
                  , "[": ["[  ]{Right}{Right}{U+FEFF}{U+FEFF}{Right}", "⌈  ⌉{Right}{Right}{U+FEFF}{U+FEFF}{Right}", "⌊  ⌋{Right}{Right}{U+FEFF}{U+FEFF}{Right}", "⸢  ⸣{Right}{Right}{U+FEFF}{U+FEFF}{Right}", "⸤  ⸥{Right}{Right}{U+FEFF}{U+FEFF}{Right}"] ;; 2
