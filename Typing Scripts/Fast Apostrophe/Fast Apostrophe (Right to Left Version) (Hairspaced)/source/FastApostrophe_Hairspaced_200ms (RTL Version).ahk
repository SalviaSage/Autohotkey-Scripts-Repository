;; FastApostrophe (Right to Left) (Hairspaced), Hold Version, 200ms
...
Menu, Tray, Tip, % "Fast Apostrophe`n( Right to Left )`n( Hairspaced )`n200 ms version"
...
;; NEED TO USE QUESTION MARKS AND EXCLAMATION MARKS WITH UNICODE CODES AND TEST AGAIN.
                  ...
                  , "(": ["(  ){Right}{Right}"] ;; 1
                  , "[": ["[  ]{Right}{Right}", "⌈  ⌉{Right}{Right}", "⌊  ⌋{Right}{Right}", "⸢  ⸣{Right}{Right}", "⸤  ⸥{Right}{Right}"] ;; 2
                  , "{": ["{{}  {}}{Right}{Right}"] ;; 3
                  , "<": ["«  »{Right}{Right}", "‹  ›{Right}{Right}", "⟨  ⟩{Right}{Right}", "⧼  ⧽{Right}{Right}"] ;; 4
