;; FastApostrophe & Quotation Marks 150ms

;; Hit the ' key on the keyboard twice within 150 milliseconds to get the ʼ key. (modifier letter apostrophe) (U+02BC)
;; Hit the " key on the keyboard twice within 150 milliseconds to get the “ ” keys. (left double quotation mark) (U+201C) + (right double quotation mark) (U+201D)
;; Hit the . key on the keyboard thrice (three times) within 150 milliseconds to get the '…' key. (horizontal ellipsis) (U+2026)
;; Hit the < key on the keyboard twice within 150 milliseconds to get the « » keys. (left-pointing double angle quotation mark) (U+00AB) + (right-pointing double angle quotation mark) (U+00BB)
;; Hit the ` key on the keyboard twice within 150 milliseconds to get the ` ` keys. (grave accent (U+0060) + grave accent (U+0060) (For fast code windows.)
...
;; Hit the '(' key on the keyboard twice within 150 milliseconds to get the '()' keys.
;; Hit the '[' key on the keyboard twice within 150 milliseconds to get the '[]' keys.
;; Hit the '{' key on the keyboard twice within 150 milliseconds to get the '{}' keys.
...
Menu, Tray, Tip, % "FastApostrophe`n150ms"
