...
Menu, Tray, Tip, % "Holdable ScrollLock`n`100 ms version`n`nToggle ScrollLock by hitting the ScrollLock key twice."

scroll := 0
*ScrollLock::
	SetScrollLockState On
	if (A_PriorHotkey == "*ScrollLock Up" and A_TimeSincePriorHotkey <= 100) {
		scroll := 1-scroll
	}
return
