...
;; It has to be hit twice within 111ms to toggle.
...
Menu, Tray, Tip, % "Holdable ScrollLock`n`111 ms version`n`nToggle ScrollLock by hitting the ScrollLock key twice."

scroll := 0
*ScrollLock::
	SetScrollLockState On
	if (A_PriorHotkey == "*ScrollLock Up" and A_TimeSincePriorHotkey <= 111) {
		scroll := 1-scroll
	}
return
