...
Menu, Tray, Tip, % "Orthography Helper`nHairspaced, No-Break (Arabic)`n250 ms version"
...
;; 16 Plus Sign, Not Equal Sign, Almost Equal Sign
                  ...
                  , "{": ["﴿  ﴾{Right}{Right}{U+FEFF}{U+FEFF}{Right}", "{{}  {}}{Right}{Right}{U+FEFF}{U+FEFF}{Right}"] ;;3
...
;; 4 Guillemets, Singular Guillemets, Angular Brackets, Curly Angular Brackets
                  ...
                  , "Numpad0": ["{U+066A}", "{U+0609}", "{U+060A}"] ;;1
                  , "NumpadDot": ["{U+066B}", "{U+060D}"]} ;;2
