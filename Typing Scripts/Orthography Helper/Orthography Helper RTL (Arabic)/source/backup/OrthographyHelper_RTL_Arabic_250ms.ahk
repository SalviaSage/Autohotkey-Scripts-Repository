;; Orthography Helper, Right To Left, Hold Version, 250ms
...
Menu, Tray, Tip, % "Orthography Helper`nRight-To-Left (Arabic)`n250 ms version"

#include Lib\TapHoldManager.ahk

#SingleInstance force
transpositions := { "'": ["’‘{Right}"] ;;1
                 , """": ["”“{Right}"] ;;2
                  , ";": [":"] ;;3
                  , "\": ["|", "‖", "¦", "⌇"] ;;4
                  , ",": ["<"] ;;5
...
;; 16 Plus Sign, Not Equal Sign, Almost Equal Sign
                  ...
                  , "(": ["(){Right}", "﴿﴾{Right}{U+FEFF}{U+FEFF}{Right}"] ;; 1
                  , "[": ["(){Right}", "[]{Right}", "{{}{}}{Right}"] ;; 2
                  , "{": ["﴿﴾{Right}{U+FEFF}{U+FEFF}{Right}", "{{}{}}{Right}"] ;; 3
...
;; 1 Parentheses, Ornate Parentheses
;; 2 Brackets, Curly Brackets
;; 3 Curly Brackets, Ornate Parentheses
;; 4 Guillemets, Singular Guillemets, Angular Brackets, Curly Angular Brackets

                  , "Numpad0": ["{U+066A}", "{U+0609}", "{U+060A}"] ;;
                  , "NumpadDot": ["{U+066B}", "{U+060D}"]} ;;

;; 1 arabic percent sign, arabic-indic per mille sign, arabic-indic per ten thousand sign
;; 2 arabic decimal separator, arabic date separator
