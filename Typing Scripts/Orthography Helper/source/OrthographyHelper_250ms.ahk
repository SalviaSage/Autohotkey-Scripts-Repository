...
Menu, Tray, Tip, % "Orthography Helper`n250 ms version"
...
;; 6 Spanish-Style Exclamation Marks, Spanish-Style Double Exclamation Marks
                  ...
                  , "NumpadDiv": ["{U+2044}", "{U+00F7}"] ;; 11
                 , "NumpadMult": ["{U+00D7}"] ;; 12
                  , "NumpadAdd": ["{U+003D}", "{U+205F}"] ;; 13
...
;; 11 Fraction Slash, Division Sign
;; 12 Multiplication Sign
;; 13 Equals Sign, Medium Mathematical Space
