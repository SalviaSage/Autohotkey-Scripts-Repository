...
;; This script makes it easier to type extra Spanish letters and punctuation marks by hitting certain keys twice within a time-frame (125ms).
...
Menu, Tray, Tip, % "SpanishTyper`nScript 125ms`nCursive`nVersion"
