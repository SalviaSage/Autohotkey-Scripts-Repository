...
;; This script makes it easier to type extra Spanish letters and punctuation marks by hitting certain keys twice within a time-frame (133ms).
...
Menu, Tray, Tip, % "SpanishTyper`nScript 133ms`nCursive`nVersion"
